<html>
	...
	<body>
		...
		<div class="isi">
			...
			<input type="submit" class="btntmbhpkt" value="Tambah Paket"/>
			<input type="submit" class="btnedtpkt" value="EDIT"/>
			<input type="submit" class="btnhpspkt" value="HAPUS"/>
			<table class="table1">
					<tr>
						<th colspan="2">Keterangan Pembayaran</th>	
					</tr>
					<tr>
						<td>Reguler 1</td>
						<td>Rp. 80.000</td>
			...
			<input type="submit" class="btntmbhpkt" value="Tambah Keterangan"/>
			<input type="submit" class="btnedtpkt" value="EDIT"/>
			<input type="submit" class="btnhpspkt" value="HAPUS"/>
			</div>
	</body>
